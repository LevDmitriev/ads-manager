 ...
 */
final class Version20200504110603 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_7AD9E4918BAC62AF ON you_renta_city_district (city_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_7AD9E4918BAC62AF');
        $this->addSql('CREATE TEMPORARY TABLE __temp__you_renta_city_district AS SELECT id, name, value FROM you_renta_city_district');
        $this->addSql('DROP TABLE you_renta_city_district');
