 ...
 */
final class Version20200509073837 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE you_renta_advertisement_update_period');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE you_renta_advertisement_update_period (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, advertisement_id INTEGER NOT NULL, period VARCHAR(255) NOT NULL COLLATE BINARY --(DC2Type:dateinterval)
        )');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_35C8D47A1FBF71B ON you_renta_advertisement_update_period (advertisement_id)');
        $this->addSql('DROP INDEX UNIQ_79FA29EC5020C33');
        $this->addSql('DROP INDEX UNIQ_79FA29E8BAC62AF');
        $this->addSql('DROP INDEX UNIQ_79FA29EB08FA272');
        $this->addSql('DROP INDEX UNIQ_79FA29E3922F2F5');
