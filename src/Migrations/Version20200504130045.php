...
final class Version20200504130045 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('INSERT INTO you_renta_advertisement (id, object_type_id, city_id, district_id, guest_count_id, street, building_number, rooms_number, price_day, price_night, price_hour, price_wedding, floor, floors_count, total_area, first_phone, second_phone, internet, conditioner, washer, parking, description, rent_conditions, rent_conditions_wedding, you_tube) SELECT id, object_type_id, city_id, district_id, guest_count_id, street, building_number, rooms_number, price_day, price_night, price_hour, price_wedding, floor, floors_count, total_area, first_phone, second_phone, internet, conditioner, washer, parking, description, rent_conditions, rent_conditions_wedding, you_tube FROM __temp__you_renta_advertisement');
