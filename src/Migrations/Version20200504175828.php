 ...
 */
final class Version20200504175828 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE you_renta_advertisement_update_period (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, advertisement_id INTEGER NOT NULL, period VARCHAR(255) NOT NULL --(DC2Type:dateinterval)
        )');
