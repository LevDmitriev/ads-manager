 ...
 */
final class Version20200504171606 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__you_renta_advertisement_photo AS SELECT id, advertisement_id, image, updated_at FROM you_renta_advertisement_photo');
        ...
        $this->addSql('INSERT INTO you_renta_advertisement_photo (id, advertisement_id, image, updated_at) SELECT id, advertisement_id, image, updated_at FROM __temp__you_renta_advertisement_photo');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__you_renta_advertisement_photo AS SELECT id, advertisement_id, image, updated_at FROM you_renta_advertisement_photo');
        $this->addSql('DROP TABLE you_renta_advertisement_photo');
        $this->addSql('CREATE TABLE you_renta_advertisement_photo (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, advertisement_id INTEGER NOT NULL, image VARCHAR(255) NOT NULL, updated_at DATETIME NOT NULL)');
        $this->addSql('INSERT INTO you_renta_advertisement_photo (id, advertisement_id, image, updated_at) SELECT id, advertisement_id, image, updated_at FROM __temp__you_renta_advertisement_photo');
        $this->addSql('DROP TABLE __temp__you_renta_advertisement_photo');
        $this->addSql('CREATE INDEX IDX_53683436A1FBF71B ON you_renta_advertisement_photo (advertisement_id)');
        $this->addSql('DROP INDEX IDX_7AD9E4918BAC62AF');
