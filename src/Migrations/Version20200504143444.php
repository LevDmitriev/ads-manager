 ...
 */
final class Version20200504143444 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE you_renta_advertisement_photo (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, advertisement_id INTEGER NOT NULL, image VARCHAR(255) NOT NULL, updated_at DATETIME NOT NULL, CONSTRAINT FK_53683436A1FBF71B FOREIGN KEY (advertisement_id) REFERENCES you_renta_advertisement (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO you_renta_advertisement_photo (id, advertisement_id, image) SELECT id, advertisement_id, file_name FROM __temp__you_renta_advertisement_photo');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX IDX_79FA29EA76ED395 ON you_renta_advertisement (user_id)');
        $this->addSql('DROP INDEX IDX_53683436A1FBF71B');
        $this->addSql('CREATE TEMPORARY TABLE __temp__you_renta_advertisement_photo AS SELECT id, advertisement_id, image FROM you_renta_advertisement_photo');
        $this->addSql('DROP TABLE you_renta_advertisement_photo');
        $this->addSql('CREATE TABLE you_renta_advertisement_photo (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, advertisement_id INTEGER NOT NULL, file_name VARCHAR(255) NOT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO you_renta_advertisement_photo (id, advertisement_id, file_name) SELECT id, advertisement_id, image FROM __temp__you_renta_advertisement_photo');
        $this->addSql('DROP TABLE __temp__you_renta_advertisement_photo');
        $this->addSql('CREATE INDEX IDX_53683436A1FBF71B ON you_renta_advertisement_photo (advertisement_id)');
        $this->addSql('DROP INDEX IDX_7AD9E4918BAC62AF');
        $this->addSql('CREATE TEMPORARY TABLE __temp__you_renta_city_district AS SELECT id, city_id, name, value FROM you_renta_city_district');
