 ...
 */
final class Version20200511103830 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_79FA29E8BAC62AF');
        $this->addSql('DROP INDEX IDX_79FA29EC5020C33');
        $this->addSql('DROP INDEX IDX_79FA29EA76ED395');
        $this->addSql('DROP INDEX IDX_79FA29EB08FA272');
        $this->addSql('DROP INDEX IDX_79FA29E3922F2F5');
        ...
        $this->addSql('CREATE INDEX IDX_79FA29E8BAC62AF ON you_renta_advertisement (city_id)');
        $this->addSql('CREATE INDEX IDX_79FA29EC5020C33 ON you_renta_advertisement (object_type_id)');
        $this->addSql('CREATE INDEX IDX_79FA29EA76ED395 ON you_renta_advertisement (user_id)');
        $this->addSql('CREATE INDEX IDX_79FA29EB08FA272 ON you_renta_advertisement (district_id)');
        $this->addSql('CREATE INDEX IDX_79FA29E3922F2F5 ON you_renta_advertisement (guest_count_id)');
        ...
        $this->addSql('CREATE TABLE you_renta_advertisement_photo (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, advertisement_id INTEGER NOT NULL, updated_at DATETIME NOT NULL, created_at DATETIME NOT NULL, image VARCHAR(255) DEFAULT NULL, CONSTRAINT FK_53683436A1FBF71B FOREIGN KEY (advertisement_id) REFERENCES you_renta_advertisement (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__you_renta_advertisement_photo AS SELECT id, advertisement_id, image, updated_at, created_at FROM you_renta_advertisement_photo');
        $this->addSql('DROP TABLE you_renta_advertisement_photo');
        $this->addSql('CREATE TABLE you_renta_advertisement_photo (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, advertisement_id INTEGER NOT NULL, updated_at DATETIME NOT NULL, created_at DATETIME NOT NULL, image VARCHAR(255) NOT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO you_renta_advertisement_photo (id, advertisement_id, image, updated_at, created_at) SELECT id, advertisement_id, image, updated_at, created_at FROM __temp__you_renta_advertisement_photo');
        $this->addSql('DROP TABLE __temp__you_renta_advertisement_photo');
        $this->addSql('CREATE INDEX IDX_53683436A1FBF71B ON you_renta_advertisement_photo (advertisement_id)');
        $this->addSql('DROP INDEX IDX_7AD9E4918BAC62AF');
